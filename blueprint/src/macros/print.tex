...
% Fully qualified Rocq names such as
% \texttt{Dynamics.majority.main.majority3\_consensus\_whp} are single
% unbreakable words wider than a text line, and used to run into the margin
% (13 overfull \hbox warnings, the worst 193pt wide). Allow a line break
% after each underscore of an identifier and give TeX a little slack for the
